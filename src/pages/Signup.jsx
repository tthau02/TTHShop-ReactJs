        ...
        <form onSubmit={handleSubmit(onSubmit)}>
          <div className="mb-4">
            ...
            <input
              ...
              {...register('username', { required: 'Không được để trống username' })}
            />
            {errors.username && <span className="p-3 text-red-500">{errors.username.message}</span>}
          </div>
          <div className="mb-4">
          ...
          <div className="mb-4">
            ...
            <input
              ...
              {...register('confirmPassword', {
                ...
                validate: (value) =>
                  value === watch('password') || 'Password không trùng khớp',
              })}
            />
            {errors.confirmPassword && (
              <span className="p-3 text-red-500">{errors.confirmPassword.message}</span>
            )}
          </div>
          <button
            type="submit"
